...
public class FRM_VentanaPrincipal extends javax.swing.JFrame {
     ...
     */
    Controlador_VentanaPrincipal controlador;
    ...
    {
        initComponents();
        controlador= new Controlador_VentanaPrincipal(this);
        this.panel_Botones1.eventos(controlador);
       this.panel_Datos1.deshablitarcampoBucar();
   ...
   public String [] agrgarUsuario()
   {
       return this.panel_Datos1.agregarUsuario();
   }
   public int devolverNumero()
   {   
      return  this.panel_Datos1.devolverNuero();
   }
   public void limiar()
   {
       this.panel_Datos1.limpiarCampo();
   }
   public void camposAgregar()
   {
       this.panel_Datos1.deshabilitarCamposAgregar();
   }
   public void mostrarDatos(String arreglo[])
   {
